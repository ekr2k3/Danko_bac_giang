...
function reloadSlide() {
    let checkLeft = items[active].offsetLeft; // offsetLeft thuộc tính có săn trong DOM lấy khoảng cách từ vị trí bên trái nó đến bên trái phần tử cha gần nó nhất
